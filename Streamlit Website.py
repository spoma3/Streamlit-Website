...
with st.container():
    ...
    with left_column:
        ...
        st.caption(f"\033[Figure 1.]\033 As shown in the plot, the R² error levels out as the number of trees passes 100, indicating that increasing the number of trees past 100 doesn’t improve the model's performance.")
        ...
        st.caption(f"\033[Figure 2.]\033 This plot demonstrates that the model steadily decreased its loss over the 8 epochs, which indicates that the training process was effective and the model was able to learn meaningful patterns in the data.")
